...
- `devloop cycle summary <cycle-id>`: shows a compact summary of a cycle. Reuses `cycle check` validation and reports cycle id, status, created_at, required files, optional files, and error count. Missing optional files are not errors.
